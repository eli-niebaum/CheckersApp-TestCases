...
public class CheckersAppRenderTest {
  ...
  @Test
  public void testCheckersAppRender() throws Exception {
    ...
    driver.findElement(By.id("username")).sendKeys("Biscuit");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("Password");
    driver.findElement(By.xpath("//input[@value='Login!']")).click();
    driver.get("http://ec2-3-145-41-84.us-east-2.compute.amazonaws.com:8080/CheckersApp/render.html");
  }
